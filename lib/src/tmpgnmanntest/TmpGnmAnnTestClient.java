...
public class TmpGnmAnnTestClient {
    ...
    public String prepareTestGenomeAnnotationFromProteins(PrepareTestGenomeAnnotationFromProteinsParams params, RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<String> res = caller.jsonrpcCall("TmpGnmAnnTest.prepare_test_genome_annotation_from_proteins", args, retType, true, true, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
    ...
    public Map<String, Object> status(RpcContext... jsonRpcContext) throws IOException, JsonClientException {
        ...
        List<Map<String, Object>> res = caller.jsonrpcCall("TmpGnmAnnTest.status", args, retType, true, false, jsonRpcContext, this.serviceVersion);
        return res.get(0);
    }
}
